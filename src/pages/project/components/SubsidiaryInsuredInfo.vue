<template>
    ...
    <div>
        ...
        <span v-if="dubsidiaryInsuranceInfo.relationToHolder !== '10000'">
...
export default {
  ...
  methods: {
    onChange: function(val) {
        sessionStorage.setItem("dubsidiaryInsuranceInfo-relationToHolder", this.dubsidiaryInsuranceInfo.relationToHolder);
